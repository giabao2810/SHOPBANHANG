      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php echo e($slide->slider_image); ?></td>
            ...
            <td><span class="text-ellipsis">
              <?php
               if($slide->slide_status==0){
                ...
                ?>  
                 <a href="<?php echo e(URL::to('/inactive-slide/'.$slide->slider_id)); ?>"><span class="fa-thumb-styling fa fa-thumbs-down"></span></a>
                <?php
               }
              ?>
            </span></td>
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\tutorial_youtube\shopbanhanglaravel\resources\views/admin/slider/list_slide.blade.php ENDPATH**/ ?>