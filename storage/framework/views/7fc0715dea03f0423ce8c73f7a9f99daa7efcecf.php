    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="<?php echo e(('public/backend/images/2.png')); ?>">
                <span class="username">
                	<?php
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="<?php echo e(URL::to('/manage-slider')); ?>">Liệt kê slider</a></li>
                        <li><a href="<?php echo e(URL::to('/add-slider')); ?>">Thêm slider</a></li>
                    </ul>
                </li>
                 ...
                 <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="<?php echo e(URL::to('/delivery')); ?>">Quản lý vận chuyển</a></li>
                ...
                <li class="sub-menu">
                 ...
                 <li class="sub-menu">
                    ...
                    <ul class="sub">
                         <li><a href="<?php echo e(URL::to('/add-users')); ?>">Thêm user</a></li>
                        <li><a href="<?php echo e(URL::to('/users')); ?>">Liệt kê user</a></li>
...
<script src="<?php echo e(asset('public/backend/js/jquery.form-validator.min.js')); ?>"></script>
...
<?php /**PATH D:\xampp\htdocs\tutorial_youtube\shopbanhanglaravel\resources\views/admin_layout.blade.php ENDPATH**/ ?>