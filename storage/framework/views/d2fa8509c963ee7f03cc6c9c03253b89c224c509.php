                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                <form role="form" action="<?php echo e(URL::to('/insert-coupon-code')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\tutorial_youtube\shopbanhanglaravel\resources\views/admin/coupon/insert_coupon.blade.php ENDPATH**/ ?>