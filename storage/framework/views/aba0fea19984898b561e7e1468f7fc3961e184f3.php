        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a onclick="return confirm('Bạn có chắc là muốn xóa thương hiệu này ko?')" href="<?php echo e(URL::to('/delete-brand-product/'.$brand_pro->brand_id)); ?>" class="active styling-edit" ui-toggle-class="">
      ...
      <div class="row">
        ...
        <div class="col-sm-7 text-right text-center-xs">                
          <ul class="pagination pagination-sm m-t-none m-b-none">
             <?php echo $all_brand_product->links(); ?>
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\tutorial_youtube\shopbanhanglaravel\resources\views/admin/all_brand_product.blade.php ENDPATH**/ ?>