                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="index.html"><img src="<?php echo e(('public/frontend/images/home/logo.png')); ?>" alt="" /></a>
                        </div>
                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                ?>
                                 <li><a href="<?php echo e(URL::to('/dang-nhap')); ?>"><i class="fa fa-crosshairs"></i> Thanh toán</a></li>
                                <?php
                                 }
                                ?>
                                ...
                                <?php
                                 ...
                                 ?>
                                 <li><a href="<?php echo e(URL::to('/dang-nhap')); ?>"><i class="fa fa-lock"></i> Đăng nhập</a></li>
                                 <?php 
                             }
                                 ?>
                            ...
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown"><a href="#">Sản phẩm<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        ...
                                        <li><a href="<?php echo e(URL::to('/danh-muc/'.$danhmuc->slug_category_product)); ?>"><?php echo e($danhmuc->category_name); ?></a></li>
                                ...
                                <li><a href="<?php echo e(URL::to('/lien-he')); ?>">Liên hệ</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-5">
                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <?php $__currentLoopData = $slider; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="item <?php echo e($i==1 ? 'active' : ''); ?>">
                                ...
                                <div class="col-sm-12">
                                    <img alt="<?php echo e($slide->slider_desc); ?>" src="<?php echo e(asset('public/uploads/slider/'.$slide->slider_image)); ?>" height="200" width="100%" class="img img-responsive img-slider">
                          ...
                          <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a href="<?php echo e(URL::to('/danh-muc/'.$cate->slug_category_product)); ?>"><?php echo e($cate->category_name); ?></a></h4>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="brands_products"><!--brands_products-->
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li><a href="<?php echo e(URL::to('/thuong-hieu/'.$brand->brand_slug)); ?>"> <span class="pull-right"></span><?php echo e($brand->brand_name); ?></a></li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>
                            </div>
                        </div><!--/brands_products-->
...
</html><?php /**PATH D:\xampp\htdocs\tutorial_youtube\shopbanhanglaravel\resources\views/layout.blade.php ENDPATH**/ ?>